...
%     Hull_2 = Hull_2(:,1:3)-xyz_position(c2,:);    
    ...
    Modeling_CHPinter_NormVol_T = [Modeling_CHPinter_NormVol_T; c c2 pos d v1 v2 v3 v3/(v1+v2-v3)*100]; 

    clear Hull_1 Hull_2
    
    cd(folder);

    save('Modeling_CHPinter_NormVol_T','Modeling_CHPinter_NormVol_T')
