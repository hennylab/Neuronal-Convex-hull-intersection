...
for c2 = 1:15
    ...
    Modeling_CHPinter_NormShape_T = [Modeling_CHPinter_NormShape_T; pos d c1 c2 v1a v2a v3a v3a/(v1a+v2a-v3a)*100];

    clear Hull_1 Hull_2 inter
    
    cd(folder);
    
    save('Modeling_CHPinter_NormShape_T','Modeling_CHPinter_NormShape_T')
